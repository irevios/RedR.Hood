...
function dibujaNivel2(arma, llave, puerta) {
    ...
    // Zona enemiga
    ctx.beginPath();
    ctx.moveTo(927.3, 87.7);
    ctx.bezierCurveTo(659.6, 88.1, 454.0, 136.6, 501.3, 313.9);
    ...
    ctx.bezierCurveTo(1705.8, 120.0, 1418.0, 113.6, 1140.8, 95.4);
    ctx.bezierCurveTo(1067.7, 90.6, 995.5, 87.6, 927.3, 87.7);
    ctx.closePath();
    ...
    ctx.lineTo(1747.1, 577.9);
    ctx.bezierCurveTo(1695.5, 578.7, 1645.7, 579.0, 1620.4, 556.3);
    ctx.lineTo(1614.1, 544.3);
    ctx.bezierCurveTo(1654.7, 567.7, 1699.5, 571.9, 1748.5, 572.1);
    ctx.bezierCurveTo(1758.2, 529.8, 1748.5, 491.4, 1747.3, 447.8);
    ctx.closePath();
    ctx.fillStyle = "rgb(210,0,210)";
    ctx.fill();
    ...
    ctx.closePath();
    ctx.moveTo(1920.0, 21.8);
    ctx.lineTo(0.0, 21.8);
    ctx.lineTo(0.0, 0.0);
    ctx.lineTo(1920.0, 0.0);
    ctx.lineTo(1920.0, 21.8);
    ctx.closePath();
    ctx.fillStyle = "rgb(0, 0, 0)";
    ctx.fill();
